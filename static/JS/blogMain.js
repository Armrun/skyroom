...
//     // 绑定获取评论事件
//     var buttonC = document.querySelectorAll('.comment-all')
//     console.log('click看所有评论', buttonC)
//     for (var i = 0; i < buttonC.length; i++) {
//         buttonC[i].addEventListener('click', function(event){
//         // console.log('click看所有评论')
